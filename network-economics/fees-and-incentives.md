...
The current code already charges transaction, contract, and selected service fees. Fee distribution, open-node incentives, and long-term economic parameters remain under design.

**Page Status: Fee Path Implemented / Incentives Design in Progress**
